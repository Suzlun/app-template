...
#### Scenario: Admin frontend は Product public surface と別ドメインで配信される (ADMIN-CONSOLE-FE-S046)

- **GIVEN** Admin frontend と Product public surface の deployment config が存在する
- **WHEN** configured domain を検証する
- **THEN** Admin domain は Product public surface domain と一致しない
