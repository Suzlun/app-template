...
admin_go_export_contamination='^(type |func )(Admin[A-Za-z0-9_]*|ListAdminAccounts|GetAdminAccount|CreateAdminAccount|FinishAdminOperatorSetup|StartAdminOperatorSetup|GetCurrentAdminOperator|LogoutAdminOperator|RefreshAdminOperatorSession|FinishAdminPasskeyAuthentication|StartAdminPasskeyAuthentication)\b'
...
product_go_export_contamination='^(type |func )(GetAccountSettings|UpdateAccountSettings|Logout|FinishPasskeyAuthentication|RegisterPasskey|StartPasskeyRegistration|StartPasskeyAuthentication|FinishReauthentication|StartReauthentication|RequestPasskeyRecovery|ConsumeRecoveryToken|RefreshToken|ListPasskeys|FinishPasskeyAddition|SendDeviceLink|StartPasskeyAddition|DeletePasskey|ListSessions|RevokeOtherSessions|RevokeSession|GetStatus)\b'
