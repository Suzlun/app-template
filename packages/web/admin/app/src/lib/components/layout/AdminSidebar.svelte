<script lang="ts">
	import { Avatar, Button, DropdownMenu, Sidebar } from '@app-template/web-ui/components';
			...
			<Sidebar.SidebarMenuItem>
				<DropdownMenu.DropdownMenu>
					...
					<DropdownMenu.DropdownMenuContent align="start" class="w-56">
						...
						<Button href="/login" variant="ghost" class="h-auto w-full justify-start rounded-sm px-3 py-2 text-sm">{logoutLabel}</Button>
