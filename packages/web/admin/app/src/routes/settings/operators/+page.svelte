<script lang="ts">
	import { useAdminOperators } from '@app-template/web-admin-domain';
	import type { AdminOperatorDomainError } from '@app-template/web-admin-domain';
	import { Button, CardNS, Dialog, Input, Label, Select, Spinner } from '@app-template/web-ui/components';
