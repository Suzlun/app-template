<script lang="ts">
	import { useAdminAccountDetail } from '@app-template/web-admin-domain';
	import type { AdminAccountDomainError } from '@app-template/web-admin-domain';
	import { Badge, Button, CardNS, ConfirmDialog, Input, Label, Separator } from '@app-template/web-ui/components';
