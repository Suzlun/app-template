<script lang="ts">
	import { useAdminAccounts } from '@app-template/web-admin-domain';
	import type { AdminAccountDomainError } from '@app-template/web-admin-domain';
	import { Button, CardNS, EmptyState, Field, Input, Label, Select, Separator, Spinner } from '@app-template/web-ui/components';
