<script lang="ts">
	...
	import { useAdminOperatorSetup } from '@app-template/web-admin-domain';
	import type { AdminOperatorSetupStartResult } from '@app-template/web-admin-domain';

	import { Button, CardNS, Input, Label, Spinner } from '@app-template/web-ui/components';
