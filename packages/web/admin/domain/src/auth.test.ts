...
} from '@app-template/web-admin-api';
...
vi.mock('@app-template/web-admin-api', () => ({
...
const loginOptions: PasskeyStartResponse = {
...
const setupOptions: PasskeyAddStartResponse = {
...
const attestationCredential: WebAuthnAttestationCredential = {
  id: 'credential-id',
