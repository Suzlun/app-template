<!--
  BrandMark — 認証 surface と公開面のヘッダーで利用する wordmark。
  ...
  表示文字は docs/brand/brand_guidelines.md 01 に従い app-template を用いる。
-->
...
<script lang="ts">
  ...
  let { size = 'md', class: className }: BrandMarkProps = $props();
